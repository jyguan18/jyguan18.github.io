...
export default function App() {
  ...
  return (
    <div className="flex flex-col h-full w-full bg-midnight">
      <div className="flex flex-col md:flex-row flex-grow overflow-hidden p-2 md:p-4 gap-2 md:gap-4">
        ...
        <div className="w-full md:w-72 flex-shrink-0 bg-lavender/50 border-2 border-lavender rounded text-gray-200 overflow-auto max-h-[50vh] md:max-h-full">
